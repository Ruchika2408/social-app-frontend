import Campaign from "../../images/campaign1.jpg";
...
const SocialPost = ({title, description, img, url}) => {
    return (
        ...
        <img src={img} className="campaignImg"/>
        <h3>{title}</h3>
        <p>
        {description} <a href="https://www.who.int/health-topics/mental-health#tab=tab_1">Click Here</a>
       </p>
       <div className="buttonsWrapper">       <button className="like">
                  <img src={Like}/>
              </button>
              <button className="comment">
                  <img src={Comment} width="200px" height="200px"/>
              </button>
              </div>
